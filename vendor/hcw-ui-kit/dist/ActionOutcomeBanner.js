...
export function ActionOutcomeBanner({ onDismiss, } = {}) {
    ...
    return (_jsx(Box, { sx: { mb: 2 }, children: _jsxs(Alert, { severity: severity, variant: "outlined", onClose: () => {
                ...
                onDismiss?.();
            }, action: outcome.status === "pending" ? (_jsx(Button, { color: "inherit", size: "small", disabled: true, children: VOICE.pendingLabel })) : undefined, children: [_jsx(AlertTitle, { children: outcome.label }), outcome.detail] }) }));
}
