/**
 * iCalendar (ICS) helpers — workload feed for calendar-app subscription.
 * Verbatim port of packages/contracts/src/calendar.ts (pure functions,
 * no framework dependency — nothing to change for the Next.js port).
 */
