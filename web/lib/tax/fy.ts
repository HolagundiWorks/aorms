 ...
 * Verbatim port of packages/contracts/src/fy.ts — the invoice tax engine
 * only needed `financialYearRange` (for the s.194J(B) per-client-per-FY
 * threshold); this file now also carries the period-filter apparatus the
 * GST/TDS filing abstract needs (`resolvePeriodRange` et al.).
 *
