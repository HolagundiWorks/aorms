/**
 * GST place of supply for an architecture practice. Verbatim port of
 * packages/contracts/src/place-of-supply.ts.
 *
 ...
 * state means CGST + SGST, anywhere else means IGST.
 */
