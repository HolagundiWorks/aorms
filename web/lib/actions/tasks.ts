 ...
 * (`tasks: staff write`, migration 0085_write_policies_require_capability.sql).
 * Added 2026-09-21 (QA finding: `/tasks`' "Add task" button was visible and
...
export async function createTaskRecord(
  ...
  if (!authProfile || !WRITE_TIER_ROLES.has(authProfile.role)) {
    return { error: "You don't have permission to add tasks — contact a firm owner or partner." };
  }
