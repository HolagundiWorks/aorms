...
import { createCompany, type PlatformActionState } from "../../../lib/actions/platform";
...
export function CreateCompanyForm() {
  ...
  return (
    <Form action={formAction}>
      <Stack gap={4}>
        <TextInput id="company-name" name="name" labelText="Company name" placeholder="Acme Architects" required />
        {state?.error ? (
