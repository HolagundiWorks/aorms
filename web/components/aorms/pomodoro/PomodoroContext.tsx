...
/**
 * Pomodoro timer state — ported near-verbatim from the old frontend's
 * contexts/PomodoroContext.tsx. Pure client-side (setInterval countdown),
 * no backend persistence — a work-session clock doesn't need to survive a
 * page reload or sync across devices any more than a stopwatch would.
 */
