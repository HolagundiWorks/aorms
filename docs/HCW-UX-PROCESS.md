...
Construction stakeholder modes: HCW-CONSTRUCTION-UX-OVERLAY.md.
...
5. Construction: safety interrupt class and field mode if applicable; cite CP-ID when using patterns.
...
| AI surfaces | esti/HCW-AI-ORCHESTRATION-UX.md |
| Construction | esti/HCW-CONSTRUCTION-UX-OVERLAY.md |
