# Holagundi — 15-minute demo script
...
## A. AORMS-Studio (architecture) — ~8 minutes

| Min | Action | Say |
|---|---|---|
| 0 | Sign in `principal@demo.aorms.in` / demo password at **studio.aorms.in** | “One Standard licence — web only.” |
