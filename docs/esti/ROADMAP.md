...
| **LF4** | Signed **WinUI 3** installer + first-run licence / hub bind | 🚧 code ✅ (#49) · Windows sign + physical bind + hub `0227` prod ([MORNING-TEST-LF4.md](MORNING-TEST-LF4.md)); Tauri legacy |
