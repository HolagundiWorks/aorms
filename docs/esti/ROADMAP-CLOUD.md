...
hosting-topology decision is now resolved and its worker/db.py port done —
the enqueue boundary + per-screen "Generate PDF" wiring are what's left of
Phase 6, not an open architecture question any more)  
**Updated:** 2026-09-05  
