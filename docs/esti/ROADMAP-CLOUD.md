...
schema+UI complete; Phase 6 is an architecture decision, not a build;
Project Brief — parallel infra, not part of any phase's activation
chain — is the one deliberately-deferred piece left)  
**Updated:** 2026-09-05  
