...
Next.js/Supabase stack migration **in progress** (Phases 1–5, 7, 8, 9
schema+UI done or UI-complete; Phase 6 is an architecture decision, not a
build; Phase 9's Tenders/Library sub-items and Phase 10 still open)  
**Updated:** 2026-09-05  
