...
| Auth | `/login`, `/access`, signup, forgot/reset, force-pw, admin login | `AuthRailLayout` | ~440px stack · login ~880px horizontal | `MarketingTopBar` (logo → landing) | none | AnalogueClock (no Pomodoro) | No |
