...
| Auth | `/login`, `/access`, signup, forgot/reset, force-pw, admin login | `AuthRailLayout` | login = header column (1200px); other auth ~440px | `MarketingTopBar` (logo → landing) | none | AnalogueClock (no Pomodoro) | No |
