...
| Auth | `/login`, `/access`, signup, forgot/reset, force-pw, admin login | `AuthRailLayout` | ~440px card | brand in card (landing Fog Gray + entourage) | none | AnalogueClock (no Pomodoro) | No |
