...
| **03** | **Components** | `src/` · [03-COMPONENT-QUALITY-CHECKLIST.md](03-COMPONENT-QUALITY-CHECKLIST.md) · catalog [14-HCW-CATALOG.md](14-HCW-CATALOG.md) |
...
| **06** | **Portal layouts** | [PAGE-STRUCTURE.md](../esti/PAGE-STRUCTURE.md) · [NAVIGATION.md](../esti/NAVIGATION.md) · [AORMS-SURFACE-URLS.md](../esti/AORMS-SURFACE-URLS.md) |
| **07** | **UX rules** | [HCW-UI-UX-PRINCIPLES.md](../esti/HCW-UI-UX-PRINCIPLES.md) · [07-UX-REVIEW-CHECKLISTS.md](07-UX-REVIEW-CHECKLISTS.md) · process: [HCW-UX-PROCESS.md](../HCW-UX-PROCESS.md) · evaluation: [HCW-UX-EVALUATION.md](../HCW-UX-EVALUATION.md) · voice: [HCW-UX-VOICE.md](../HCW-UX-VOICE.md) · KPIs: [HCW-UX-KPI-INSTRUMENT.md](../esti/HCW-UX-KPI-INSTRUMENT.md) (desktop-specific WinUI/parity/AI-orchestration/construction-overlay UX docs removed — the 2026-09 pivot dropped desktop apps entirely, see `CLAUDE.md` § Removed) |
...
| **09** | **DesignOps** | Contribution · semver · deprecation |
